...
ft_strdel.c ft_strlen.c ft_strnew.c ft_tolower.c ft_isalnum.c ft_memccpy.c\
ft_putchar.c ft_putstr_fd.c ft_strdup.c ft_strmap.c ft_strnstr.c ft_toupper.c\
ft_isalpha.c ft_memchr.c ft_putchar_fd.c ft_strcat.c ft_strequ.c ft_strmapi.c\
ft_strrchr.c ft_isascii.c ft_memcmp.c ft_putendl.c ft_strchr.c ft_striter.c\
...
ft_toupper.o ft_isalpha.o ft_memchr.o ft_putchar_fd.o ft_strcat.o ft_strequ.o\
ft_strmapi.o ft_strrchr.o ft_isascii.o ft_memcmp.o ft_putendl.o ft_strchr.o\
ft_striter.o ft_strncat.o ft_strsplit.o ft_isdigit.o ft_memcpy.o\
